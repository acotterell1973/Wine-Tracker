...
{
    public class MasterDetailTabNavigstionService : MasterDetailPage, IFreshNavigationService
    {
        private FreshTabbedNavigationContainer _tabbedNavigations;
        private Page _searchPage;
        private Page _shopServiceHistoryPage;

        public MasterDetailTabNavigstionService()
        {
        ...
        private void SetupTabbedPage()
        {
            ...
            _searchPage = _tabbedNavigations.AddTab<ScanProductViewModel>("Scan", "");
